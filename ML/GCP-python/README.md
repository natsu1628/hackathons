Contains sample python code to connect to GCP and use BigQuery and AutoML. It also K-Means algorithm to find the median points of 3 clusters as per the dataset provided as input.
